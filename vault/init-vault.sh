...
GITHUB_TOKEN='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'

# Agrega secretos desde un archivo de texto (solo para corrección)
apk add --no-cache curl
curl -H "Authorization: token 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" -o secrets.txt  "https://raw.githubusercontent.com/adelcor/secret/main/secrets.txt"
