...
GITHUB_TOKEN='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'

# Agrega secretos desde un archivo de texto (solo para corrección)
apk add --no-cache curl
curl -H "Authorization: token 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" -o secrets.txt  "https://raw.githubusercontent.com/adelcor/secret/main/secrets.txt"
