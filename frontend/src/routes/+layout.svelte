...
<div>
  <div class="sm:hidd">
    <div
      class="neon-pink glowing-btn absolute rounded-lg bg-[rgba(50,21,43,1)] bg-resize:w-[calc(3.7vw+5px)] bg-resize:h-[calc(12vh+11vw)] bg-resize:mt-[6.5%] bg-resize:ml-[72%] flex items-center justify-center"
    >
    ...
    <div
      class="neon-blue glowing-btn absolute rounded-lg bg-[rgba(11,60,71,1)] bg-resize:w-[calc(3.7vw+5px)] bg-resize:h-[calc(8vh+8vw)] bg-resize:mt-[31.5%] bg-resize:ml-[22.7%] flex items-center justify-center"
    >
